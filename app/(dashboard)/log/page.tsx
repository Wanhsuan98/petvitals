...
export default function LogPage() {
  ...
  return (
    <div className="space-y-4">
      <h1 className="text-xl font-semibold">每日打卡</h1>
      ...
      {todayLogs.length > 0 && (
        <section className="space-y-2 border-t pt-4" aria-label="今日已記錄">
          <h2 className="text-sm font-medium text-muted-foreground">今日已記錄</h2>
